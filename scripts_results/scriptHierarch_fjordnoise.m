...
%   Script to generate figures for hierarchical decomp. of noisy fjord %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

rng(2206) %control random noise

I=rgb2gray(imread("Data/fjord.jpg"));
I=im2double(imresize(I,[512,512])) + randn(512)/16; D=[0,0;1,1];
f=flipud(I)';
...
figure(8)
im2Dsetup(f,D,[0,1]);
exportgraphics(gca,'./Results/imageHierarch_fjordnoise_f.png');
clf;
%}
...
exportgraphics(gca,strcat('./Results/imageHierarch_fjordnoise_u', ...
                          num2str(0), '.png'));
for l=1:10
...
for l=0:10
  ...
  exportgraphics(gca,strcat('./Results/imageHierarch_fjordnoise_v', ...
                            num2str(l), '.png'));
  clf;
end
%}
...
for l=0:10
  ...
  exportgraphics(gca,strcat('./Results/imageHierarch_fjordnoise_us', ...
                            num2str(l), '.png'));
  clf;
end
%}