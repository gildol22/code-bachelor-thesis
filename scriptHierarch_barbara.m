...
%   Script to generate figures for hierarchical decomp. of barbara  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
figure(8)
im2Dsetup(f,D,[0,1]);
exportgraphics(gca,'./Results/imageHierarch_barbara_f.png');
clf;
%}
...
exportgraphics(gca,strcat('./Results/imageHierarch_barbara_u', ...
                          num2str(0), '.png'));
for l=1:10
...
for l=0:10
  ...
  exportgraphics(gca,strcat('./Results/imageHierarch_barbara_v', ...
                            num2str(l), '.png'));
  clf;
end
%}
...
for l=0:10
  ...
  exportgraphics(gca,strcat('./Results/imageHierarch_barbara_us', ...
                            num2str(l), '.png'));
  clf;
end
%}